                ...
                <div key={item.card.info.id}
                    ...
                    <div className="w-9/12">
                        <div className="py-2">
                            ...
                            <span className="text-md text-gray-900 font-medium py-1"> - ₹{item.card.info.price / 100}</span>
                        </div>
                        <p className="text-sm text-gray-500 py-1">{item.card.info.description}</p>
                    </div>
                    <div className="w-3/12 p-4 relative">
                        <img src={imageUrl + item.card.info.imageId} className="w-full rounded-lg" />
